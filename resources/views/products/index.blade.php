                    ...
                    <div class="flex items-center gap-x-5">
                        ...
                        <div class="flex">
                            ...
                            <ul
                                ...
                                >
                                    <a href="{{route('products.index',generateSortRoute('newest')) }}">جدید ترین</a>
                                </li>
                                <li
                                    class="{{activeSort('best_selling')}}"
                                >
                                    <a href="{{route('products.index',generateSortRoute('best_selling'))}}">پرفروش ترین</a>
                                </li>
                                <li
                                    class="{{activeSort('lowest')}}"
                                >
                                    <a href="{{route('products.index',generateSortRoute('lowest'))}}">ارزان ترین</a>
                                </li>
                                <li
                                    class="{{activeSort('highest')}}"
                                >
                                    <a href="{{route('products.index',generateSortRoute('highest'))}}">گران ترین</a>
                                </li>
                            </ul>
